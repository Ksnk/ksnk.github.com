...
<% // if you like to create pure JS file by yourself - just replace all asp-like
   // tags with php tags and execute with native php
%>
 */
...
var orfFilter = (function () {
    ...
    // So let's make all this array a bit close with javascript
    $res=array();
